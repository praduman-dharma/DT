            ...
            <form action="" method="post" id="form" enctype="multipart/form-data">
                <table cellspacing="2" align="center" cellpadding="8" border="0">
                    <tr>
                        ...
                        <td><input type="text" placeholder="Enter user here" id="t1" class="tb" name="name" value="<?php if (isset($row['name'])) {
                                                                                                                        echo $row['name'];
                                                                                                                    } ?>"></td>
                    </tr>
                    <tr>
                        <td align="right" class="bold">Enter Email ID :</td>
                        <td><input type="email" placeholder="Enter Email ID here" id="t2" class="tb" name="email" value="<?php if (isset($row['email'])) {
                                                                                                                                echo $row['email'];
                                                                                                                            } ?>"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input type="file" class="img" name="my_image" value="<?php if (isset($row['image_url'])) {
                                                                                        echo $row['image_url'];
                                                                                    }
                                                                                    ?>"></td>
                    </tr>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <button type="submit" name="view" class="btn"><a href="admin.php">View</a></button>
                        </td>
                    </tr>
                </table>
            </form>
