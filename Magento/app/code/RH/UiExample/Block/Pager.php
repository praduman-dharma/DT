...
class Pager extends Template
{
    ...
    public function __construct(
        ...
        \RH\UiExample\Model\Blog $customFactory, // Add your custom Model
        \RH\UiExample\Model\ResourceModel\Blog\CollectionFactory $customdataCollection, // Add your custom Model
        array $data = []
    ) {
