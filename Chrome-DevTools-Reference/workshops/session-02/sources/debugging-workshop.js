...
// The task summary count is correct, but card styling does not always match.
// Set a breakpoint inside renderTasks() and inspect task.done vs task.completed.
...
function renderTasks() {
    ...
    for (const task of tasks) {
        ...
        if (task.completed) {          // Bug: should be task.done
